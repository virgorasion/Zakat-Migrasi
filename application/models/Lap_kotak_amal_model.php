...
class Lap_kotak_amal_model extends CI_model
{
    ...
    {
        $this->datatables->select("kas_masjid.id,kas_masjid.id_admin,master_login.nama,kas_masjid.nama_donatur,kas_masjid.jumlah,kas_masjid.keterangan,kas_masjid.tanggal,tipe_donasi.tipe,kas_masjid.id_tipe");
        ...
        $this->datatables->add_column('action', '<a href="javascript:void(0)" class="edit_data btn btn-warning btn-xs" data-id="$1" data-id_admin="$2" data-donatur="$3" data-jumlah="$4" data-keterangan="$5" data-tanggal="$6" data-tipe="$9" data-nama_admin="$8"><i class="far fa-edit"></i></a> <a href="javascript:void(0)" class="delete_data btn btn-danger btn-xs" data-id="$1" data-donatur="$3" data-jumlah="$4" data-tanggal="$6" data-tipe="$7"><i class="fas fa-trash-alt"></i></a>', 
        'id,id_admin,nama_donatur,jumlah,keterangan,tanggal,tipe,nama,id_tipe');
