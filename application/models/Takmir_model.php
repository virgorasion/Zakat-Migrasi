...
class Takmir_model extends CI_model
{
    ...
    public function get_data_anggota()
    {
        ...
        $this->datatables->add_column(
            'action',
            '<a href="javascript:void(0)" class="edit_data btn btn-warning btn-xs" data-id="$1" data-nama="$2" data-alamat="$3" data-hp="$4" data-telp="$5" data-jk="$6"><i class="fas fa-edit"></i></a> <a href="javascript:void(0)" class="delete_data btn btn-danger btn-xs" data-nama="$2" data-id="$1"><i class="fas fa-trash-alt"></i></a>',
        'id_anggota,
        nama,
        alamat,
        no_hp,
