...
<div class="container">
  ...
  <br>Kapas Madya
  <br>083849575737
  <center><h1 style="background-color: #D4D4D4"><b>Jadwal Sholat Tarawih</b></h1></center>
          ...
          <table id="datatable" class="table table-bordered table-hover">
            ...
            <tbody>
                ...
                ?>
                    <tr>                              
                        <td class="no"><?= $no ?></td>
                        <td class="tanggal"><?= $data->tgl ?></td>
                        <td class="imam"><?= $data->imam ?></td>
                        <td class="bilal"><?= $data->bilal ?></td>
                        <td class="ceramah"><?= $ceramah ?></td>
                    </tr>
                <?php 
                $no++;
                endforeach
