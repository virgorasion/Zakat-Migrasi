    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <!-- form start -->
          <form class="form-horizontal" action="<?php echo site_url('Amal_idul_fitri/aksi')?>" method="post">
          ...
          ?>
                       ...
                       <input type="hidden" class="form-control" id="id_admin" name="id_admin" value="<?php echo $admin ;?>">
    ...
    <div class="box">        
        ...
        <?php if (isset($_SESSION['msg'])) {?>  
         ...
         <form method="post" action="<?php echo site_url("/Amal_idul_fitri/index")?>" id="formsearch">
          ...
          <div class="col-xs-1">
         <?php if($this->session->userdata("4view")=="1"){ ?>
      ...
      $.confirm({
        ...
        buttons: {
            deleteUser: {
                text: 'Delete',
                action: function () {
                  window.location = "Amal_idul_fitri/hapus/"+$kode;
                }
            },
            Cancel: function () {
            }
