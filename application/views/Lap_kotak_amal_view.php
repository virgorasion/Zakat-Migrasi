                            ...
                            <div class="tab-pane fade" id="demo-bsc-tab-2">
                                ...
                                <form action="<?php echo site_url('Lap_kotak_amal_controller/input_data'); ?>" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-7">
                                            <select class="form-control selectpicker" name="addTipe" id="addTipe">
                        ...
                        <div class="modal-body">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="editPetugas" name="editPetugas" value="<?php echo $_SESSION['nama'] ?>" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="editJumlah" name="editJumlah" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" name="editCatatan" id="editCatatan" rows="3"></textarea>
                                    </div>
                                </div>
