...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Kotak Amal Jum'at</li>
    </ol>
  </section>
  <!-- Main content -->
  <section class="content">
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <!-- form start -->
          <form class="form-horizontal" action="<?php echo site_url('jumat_php/tambah')?>" method="post">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal">
                <span aria-hidden="true">&times;</span>
                <span class="sr-only">Close</span>
              </button>
              <h4 class="modal-title" id="myModalLabel">Laporan Amal Jum'at</h4>
            </div>
    ...
    <div class="modal fade" id="modalEdit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <!-- form start -->
          <form id="formEdit" class="form-horizontal" action="<?php echo site_url('jumat_php/editData')?>" method="post">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal">
                <span aria-hidden="true">&times;</span>
                <span class="sr-only">Close</span>
              </button>
              <h4 class="modal-title" id="myModalLabel">Edit Amal Jum'at</h4>
            </div>
            <div class="modal-body">
              <div class="box-body">
    ...
    <div class="box">
      <div class="box-header">
        ...
        <form method="post" action="<?php echo site_url("jumat_php/index")?>" id="formsearch">
          <div class="col-sm-12">
      ...
      $.confirm({
        ...
        buttons: {
            deleteUser: {
                text: 'Delete',
                action: function () {
                  window.location = "jumat_php/hapus/"+$item.find("#id").val();
                }
            },
            Cancel: function () {
            }
