...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 25, 2021 at 04:36 PM
...
(5, '#', 'fa fa-university', 'PENGATURAN TPA', 1, 'YES'),
...
(2, 1, 'H', NULL, '2021-06-23', NULL),
(3, 2, 'I', NULL, '2021-06-23', NULL);
...
(2, 1, 1, 80, 1, '-', '2021-06-23', 1),
(3, 1, 2, 76, 1, '-', '2021-06-23', 1);
...
(2, 2, 'Fatin Zahidah ', 'P', 'Jl. raden said', 'ojan', '0823462323', '2021-06-23', NULL, '2001-06-05', '966226');
...
--
ALTER TABLE `menu_level`
  MODIFY `kode_menu_level` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=154;
